 ...
 */
public class TvFragment extends Fragment implements BGABanner.OnItemClickListener, BGABanner.Adapter {
    ...
    public void onStart(){
        super.onStart();
        mDefaultBanner = (BGABanner) getActivity().findViewById(R.id.banner_main_cube);
